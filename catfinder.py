...
<div id="filterBar" style="position:sticky;top:0;z-index:100;background:#fff;border-bottom:1px solid #e0e0e0;padding:.9rem 2rem;display:flex;align-items:center;gap:1rem;flex-wrap:wrap;">{slider}
...
header .stats {{ color: #666; font-size: .95rem; }}
...
.card .reason {{ font-size: .95rem; color: #333; flex: 1; }}
.card a.btn {{ margin-top: .5rem; display: inline-block; background: #1976d2; color: #fff; padding: .55rem .9rem; border-radius: 6px; text-decoration: none; text-align: center; font-weight: 500; }}
